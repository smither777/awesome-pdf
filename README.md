...
* [PDF Smaller](https://pdfsmaller.com) - Free browser-based PDF compression, merging, splitting, and encryption. 100% client-side processing with no uploads.
...
* [@pdfsmaller/pdf-encrypt-lite](https://www.npmjs.com/package/@pdfsmaller/pdf-encrypt-lite) - Lightweight JavaScript library for PDF password protection. Pure JS, no native dependencies.
